...
export const routes: Routes = [
  ...
  { path: 'professor/estudio/:courseId/modulos', loadComponent: () => import('./components/course-modules/course-modules.component').then(m => m.CourseModulesComponent), canActivate: [authGuard] },
  { path: 'professor/estudio/:courseId/modulos/:moduleId/disciplinas', loadComponent: () => import('./components/module-disciplines/module-disciplines.component').then(m => m.ModuleDisciplinesComponent), canActivate: [authGuard] },
  { path: 'professor/estudio/:courseId/disciplinas/:subjectId', loadComponent: () => import('./components/subject-studio/subject-studio.component').then(m => m.SubjectStudioComponent), canActivate: [authGuard] },
  ...
  { path: 'professor/planos', loadComponent: () => import('./components/professor-plans/professor-plans.component').then(m => m.ProfessorPlansComponent), canActivate: [authGuard] },
